...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 84, 140, -1, sizeof(::TST::TableStylePropertiesArchive)},
  { 190, 199, -1, sizeof(::TST::TableStylePresetArchive)},
  { 202, 209, -1, sizeof(::TST::TableStrokePresetArchive)},
  { 210, -1, -1, sizeof(::TST::ThemePresetsArchive)},
};
...
const ::_pbi::DescriptorTable descriptor_table_TSTStylePropertyArchiving_2eproto = {
    false, false, 4770, descriptor_table_protodef_TSTStylePropertyArchiving_2eproto,
...
// @@protoc_insertion_point(message_clear_start:TST.TableStylePropertiesArchive)
  ...
  if (cached_has_bits & 0x000000f8u) {
    ::memset(&_impl_.banded_rows_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.h_strokes_visible_) -
        reinterpret_cast<char*>(&_impl_.banded_rows_)) + sizeof(_impl_.h_strokes_visible_));
  }
  if (cached_has_bits & 0x0000ff00u) {
    ::memset(&_impl_.hr_separator_visible_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.table_hr_divider_visible_) -
        reinterpret_cast<char*>(&_impl_.hr_separator_visible_)) + sizeof(_impl_.table_hr_divider_visible_));
  }
